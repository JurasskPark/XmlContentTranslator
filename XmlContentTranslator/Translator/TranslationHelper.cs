...
{
    /// <summary>
    /// Helper methods executed before and after translation.
    /// <para>Вспомогательные методы, выполняемые до и после перевода.</para>
    /// </summary>
    public static class TranslationHelper
    {
        ...
        /// <summary>
        /// Applies post-translation fixes.
        /// <para>Применяет исправления после перевода.</para>
        /// </summary>
        ...
        /// <summary>
        /// Applies pre-translation normalization.
        /// <para>Применяет нормализацию перед переводом.</para>
        /// </summary>
        public static string PreTranslate(string s, string source)
        {
            if (source == "en")
            {
                ...
                s = Regex.Replace(s, @"\b(W|w)ho's ", "$1ho is ");
                s = Regex.Replace(s, @"\B'(C|c)ause ", "$1ecause ");
            }
